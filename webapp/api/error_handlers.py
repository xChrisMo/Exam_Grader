...
class APIErrorHandler:
    ...
    def handle_validation_error(self, errors: Dict[str, Any], request_id: Optional[str] = None) -> Tuple[Dict[str, Any], int]:
    ...
    def handle_authentication_error(self, message: str = "Authentication required", request_id: Optional[str] = None) -> Tuple[Dict[str, Any], int]:
    ...
    def handle_authorization_error(self, message: str = "Insufficient permissions", request_id: Optional[str] = None) -> Tuple[Dict[str, Any], int]:
    ...
    def handle_not_found_error(self, resource: str = "Resource", request_id: Optional[str] = None) -> Tuple[Dict[str, Any], int]:
    ...
    def handle_rate_limit_error(self, retry_after: int = 60, request_id: Optional[str] = None) -> Tuple[Dict[str, Any], int]:
    ...
    def handle_service_unavailable_error(self, service: str = "Service", request_id: Optional[str] = None) -> Tuple[Dict[str, Any], int]:
