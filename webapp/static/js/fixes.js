...
window.NotificationManager = {
    ...
    createNotification: function (message, type, duration, options) {
        ...
        notification.innerHTML = this.getNotificationHTML(message, type, !persistent);
    ...
    getNotificationHTML: function (message, type, showClose) {
        const icons = {
            ...
            <div class="flex items-center">
                ...
                ${showClose ? `
                    <div class="ml-auto pl-3">
                        <button type="button" class="inline-flex rounded-md p-1.5 ${buttonColors[type] || buttonColors.info} focus:outline-none" onclick="NotificationManager.remove('${notification.id}')">
...
window.showNotification = function (message, type = 'info', duration = 5000, options = {}) {
    ...
    // Create notification element
    const notification = document.createElement('div');
    notification.className = `fixed top-4 right-4 z-50 max-w-sm bg-white border-l-4 rounded-lg shadow-lg p-4 transform transition-all duration-300 ${type === 'error' ? 'border-red-500 bg-red-50' :
    ...
    notification.innerHTML = `
        <div class="flex items-center">
            ...
            <div class="ml-3">
                <p class="text-sm font-medium ${type === 'error' ? 'text-red-800' :
            ...
            <div class="ml-auto pl-3">
                <button type="button" class="inline-flex rounded-md p-1.5 ${type === 'error' ? 'text-red-500 hover:bg-red-100' :
