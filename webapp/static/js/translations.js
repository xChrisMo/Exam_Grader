...
ExamGrader.translations = {
    ...
    'en': {
        ...
        'max_file_size_description': 'Maximum size allowed for uploaded files (1-100 MB)',
    ...
    'es': {
        ...
        'max_file_size_description': 'Tamaño máximo permitido para archivos cargados (1-100 MB)',
