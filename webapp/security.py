...
class SecurityValidator:
    ...
    def validate_file_path(
        cls, file_path: str, allowed_base_path: str
    ...
    def validate_file_size(
        cls, size_bytes: int, file_type: str = "default"
    ) -> Tuple[bool, Optional[str]]:
        """
        Validate file size.
        ...
        if size_bytes > max_size:
            ...
            return (
                False,
                f"File too large. Maximum size for {file_type} files is {max_mb:.1f}MB",
            )
...
class RateLimiter:
    ...
    def is_allowed(
        self, identifier: str, max_requests: int = 100, window_seconds: int = 3600
    ) -> bool:
        """
