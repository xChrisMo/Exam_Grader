...
class StructuredLogger:
    ...
    def _validate_fields(self, fields: Dict[str, Any]):
        ...
        if "duration" in fields and fields["duration"] is not None:
            if (
                not isinstance(fields["duration"], (int, float))
                or fields["duration"] < 0
            ):
        ...
        if "response_time" in fields and fields["response_time"] is not None:
            if (
                not isinstance(fields["response_time"], (int, float))
                or fields["response_time"] < 0
            ):
        ...
        if "memory_usage" in fields and fields["memory_usage"] is not None:
            if (
                not isinstance(fields["memory_usage"], (int, float))
                or fields["memory_usage"] < 0
            ):
    ...
    def log_exception(
        ...
        **kwargs,
        ...
        extra = self._prepare_extra(
            error_type=exception.__class__.__name__, error_id=error_id, **kwargs
        )
...
class StructuredLoggerManager:
    ...
    def get_logger(self, name: str, **config_overrides) -> StructuredLogger:
