...
class CircuitBreaker:
    ...
    def _record_success(self, execution_time: float):
        ...
        logger.debug(f"Circuit breaker '{self.name}' success (took {execution_time:.2f}s)")
    ...
    def _record_failure(self, exception: Exception):
        ...
        logger.debug(f"Circuit breaker '{self.name}' failure #{self.failure_count}: {str(exception)}")
