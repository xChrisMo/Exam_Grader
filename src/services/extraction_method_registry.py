...
class ExtractionMethodRegistry:
    ...
    def register_method(self, name: str, func: Callable, file_types: List[str], 
                       priority: ExtractionPriority, dependencies: List[str] = None,
        ...
        logger.info(f"Registered extraction method: {name} for {file_types} "
    ...
    def extract_with_method(self, method_name: str, file_path: str, 
    ...
    def extract_with_fallback(self, file_path: str, context: Dict[str, Any] = None) -> ExtractionResult:
    ...
    def _update_average_processing_time(self, method_info: ExtractionMethodInfo, new_time: float):
        ...
        if method_info.successful_attempts == 1:
            ...
            # Running average
            total_time = method_info.average_processing_time * (method_info.successful_attempts - 1)
            method_info.average_processing_time = (total_time + new_time) / method_info.successful_attempts
    ...
    def get_method_info(self, method_name: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            'last_used': method_info.last_used.isoformat() if method_info.last_used else None,
            'last_availability_check': method_info.last_availability_check.isoformat() if method_info.last_availability_check else None
        }
    
    def get_all_methods_info(self) -> Dict[str, Any]:
        """Get information about all registered methods"""
        return {
            'methods': {name: self.get_method_info(name) for name in self._methods.keys()},
            'file_type_mappings': dict(self._file_type_methods),
            'total_methods': len(self._methods),
            'available_methods': sum(1 for m in self._methods.values() if m.is_available)
        }
    
    # Default extraction method implementations
    
    def _extract_pdf_pypdf2(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_pdf_pdfplumber(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_pdf_pdfminer(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_docx_python_docx(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_docx_docx2txt(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_doc_antiword(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
        ...
        metadata = {
            'extraction_library': 'antiword'
        }
        
        return content, metadata
    
    def _extract_rtf_striprtf(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_rtf_regex(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_html_beautifulsoup(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_html_regex(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_text_utf8(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
        ...
        metadata = {
            'encoding': 'utf-8',
            'extraction_library': 'builtin'
        }
        
        return content, metadata
    
    def _extract_text_chardet(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
    ...
    def _extract_text_fallback(self, file_path: str, context: Dict[str, Any]) -> Tuple[str, Dict[str, Any]]:
