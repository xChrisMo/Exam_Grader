    ...
    def cleanup_idle_resources(self) -> int:
        ...
        with self._lock:
            ...
            for resource_info in self._pool:
                ...
                if idle_time < self.max_idle_time or len(active_resources) < self.min_size:
...
class ResourceOptimizer:
    ...
    def create_resource_pool(self, name: str, factory: Callable[[], Any],
                           max_size: int = 10, min_size: int = 2,
                           max_idle_time: int = 300) -> ResourcePool:
    ...
    def optimize_resources(self) -> List[OptimizationAction]:
        ...
        for resource_type, usage in resources.items():
            ...
            if usage.usage_percentage > (threshold * 100):
                optimization_actions = self._optimize_resource(usage.resource_type, usage)
    ...
    def _optimize_resource(self, resource_type: ResourceType, 
    ...
    def get_optimization_stats(self) -> Dict[str, Any]:
        ...
        successful_actions = sum(1 for action in self.optimization_actions if action.success)
        ...
        return {
            ...
            'current_resources': {k: v.to_dict() for k, v in self.get_system_resources().items()},
